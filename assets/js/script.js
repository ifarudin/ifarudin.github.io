...
// Dirubah 
const pengirim = "cowo akuu";
const nomorWa = "6289526305566" // awalan nomor 0 harus di awalin 62
const textWa = "SAYANGGKUUU CAMATT ANNIV YANG KE 3 YAAAAA LOVE YOUU SO MUCH MUCH SAYANGKUUU MIFTAHUS SURUR IFARUDINNNN"
const pesan = `tapi itu semua nda penting ifar maunya manggil sayangg ajaa. SAYANGG??? KITA HARI INI JUMAT 10 MEI 2024 ANNIV KE 3 KITAA HIHIII. Ifar nda minta banyak ke sayangg ifarr mintaa sayangg sehatt terus yaa, ifarr minta sayangg happy teruss ifarr ndamau hilang senyuman sayangg otteii. LOVE YOU SO MUCH MUCH SAYANGKUU<33 `;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'ayoooo di isii duluu namanyaaa yaaaaaa',
    ...
    preConfirm: () => {
      ...
      if (!login) {
        Swal.showValidationMessage(`SAYANGGG III MASUKINN NAMANYAA YANG BENERR`)
      }
      return { login }
    }
  }).then((result) => {
    ...
    let txt = `hawwooo, nama sayangg ${result.value.login}, nama sayangg berawal dari huruf ${namaAwal.toUpperCase()}, ${pesan}`;
